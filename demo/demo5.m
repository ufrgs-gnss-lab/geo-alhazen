% Comparison among algorithms over different elevation
...
function [comp90, comp45, comp30, comp10, comp5, comp0, comp_algs] = get_comp_elev (fuji, mn, helm, mil, fer, e_dom)
    ...
    for i=1:numel(e_dom)
        switch i
            case 1
                comp90 = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
            case 2
                comp45 = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
            case 3
                comp30 = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
            case 4
                comp10 = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
            case 5
                comp5  = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
            case 6
                comp0  = [c1(i,:); c2(i,:); c3(i,:); c4(i,:); c5(i,:); c6(i,:); c7(i,:); c8(i,:); c9(i,:); c10(i,:)];
        end
    end
    
    comp_algs = {'1=Fuj-MN', '2=Fuj-H','3=Fuj-Mil','4=Fuj-Fer','5=MN-H','6=MN-Mil','7=MN-Fer','8=H-Mil','9=H-Fer','10=Mil-Fer'};
