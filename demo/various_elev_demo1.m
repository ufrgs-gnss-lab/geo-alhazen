%% Comparison to Fujimura: Figures for supplementary material
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, Di_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, Di_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, Di_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, Di_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, g_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, g_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, g_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, g_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, arclen_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, arclen_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, arclen_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, arclen_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
        ylabel ('Differences (m)')
    end
legend (leg, 'Location', 'none', 'NumColumns',5)
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, sldist_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, sldist_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, sldist_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, sldist_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
        ylabel ('Differences (m)')
    end
legend (leg, 'Location', 'none', 'NumColumns',5)
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, X_spec_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, X_spec_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, X_spec_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, X_spec_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
        ylabel ('Differences (m)')
    end
legend (leg, 'Location', 'none', 'NumColumns',5)
...
figure
    for i=1:numel(t)
        ...
        switch i
            case 1
                plot(Ha_dom, Y_spec_c60'); title ('e=60°'); xlabel ('Height (m)'); grid on
            case 2
                plot(Ha_dom, Y_spec_c45'); title ('e=45°'); xlabel ('Height (m)'); grid on
            case 3
                plot(Ha_dom, Y_spec_c30'); title ('e=30°'); xlabel ('Height (m)'); grid on
            case 4
                plot(Ha_dom, Y_spec_c10'); title ('e=10°'); xlabel ('Height (m)'); grid on
        end
        ylabel ('Differences (m)')
    end
legend (leg, 'Location', 'none', 'NumColumns',5)
